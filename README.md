...
- rv128\_ariane\_testharness : contains a Makefile generated by riscvbarelib that can be use to compile a code
 
Main contributors
=================
I would like to thanks my beloved students at Ensimag that choose to do their 2A (bachelor level) intership at TIMA on these subjects, without their help the project would still struggle to survive!

In particular, I'd like to acknowledge the work of:
- Fabien Portas (2020), that contributed to supporting 128-bit in QEMU, basis on which I build the upstreamed patches
- Sylvain Noiry (2022), who did the work on gcc and the binutils
- Liam-Angelo Giono (2025), who took over the binutils, made the necessary changes in newlib, and added tests
